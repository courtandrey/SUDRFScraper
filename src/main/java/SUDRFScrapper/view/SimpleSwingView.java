...
import SUDRFScrapper.configuration.searchrequest.article.CASArticle;
import SUDRFScrapper.configuration.searchrequest.article.CriminalArticle;
import SUDRFScrapper.dump.model.Dump;
import SUDRFScrapper.service.SystemHelper;
...
public class SimpleSwingView implements View {
    ...
    @Override
    public synchronized void showFrameWithInfo(Frame frame, String message) {
        switch (frame) {
